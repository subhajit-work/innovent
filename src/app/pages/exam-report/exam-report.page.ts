...
@Component({
  ...
  templateUrl: './exam-report.page.html',
  styleUrls: ['./exam-report.page.scss'],
})

export class ExamReportPage implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.parms_action_purpose = this.activatedRoute.snapshot.paramMap.get('purpose');
    ...
    console.log('parms_action_purpose', this.parms_action_purpose);
    

    // view page url name
    this.listing_view_url = 'test_result.php?exam_id='+this.parms_action_exam_id+'&center_id='+this.parms_action_center_id+'&exam_date='+this.parms_action_exam_date;
  ...
  downloadPdf(){
    ...
    window.open(this.main_url+'/report_download.php?exam_id='+this.parms_action_exam_id+'&exam_date='+this.parms_action_exam_date+'&student_id='+this.get_user_dtls.student_id+'&exam_date='+this.parms_action_exam_date+'&center_id='+this.parms_action_center_id, "_blank");
  }
  // Download pdf end
  ...
  ratingComponentClick(clickObj: any, _link): void {
    ...
    this.ratingSubscribe = this.http.post(_link+'?exam_id='+clickObj.itemId+'&rating_value='+clickObj.rating,'rating').subscribe(
    (res:any) => {
